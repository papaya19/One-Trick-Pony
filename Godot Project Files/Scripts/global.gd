...
var ship_stats = {
	...
	"magazine_size": 6, "bullet_damage": 30, "reload_time": 2.2, "shooting_speed": 1.2, "spread": 0.3, "bullets_per_shot": 5},
	
	"Assault Rifle": {"texture_file_path": "res://Assets/Ships/Assault Rifle.png", 
	"magazine_size": 20, "bullet_damage": 60, "reload_time": 1.3, "shooting_speed": 0.3, "spread": 0, "bullets_per_shot": 1},
	
	"Sniper": {"texture_file_path": "res://Assets/Ships/Sniper.png", 
	"magazine_size": 3, "bullet_damage": 180, "reload_time": 3.25, "shooting_speed": 1.25, "spread": 0, "bullets_per_shot": 1}
